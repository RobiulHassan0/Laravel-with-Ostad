...
<head>
    ...
    <title>Create Category - Admin | Simple Blog</title>
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-dark min-h-screen fixed left-0 top-0">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-700">
                <a href="../login.html" class="flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/10 rounded-lg transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
