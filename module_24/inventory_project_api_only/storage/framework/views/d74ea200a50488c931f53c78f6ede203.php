                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label" for="stockInQuantity">Quantity <span
                                    class="text-danger">*</span></label>
                            <input type="number" name="quantity" id="stockInQuantity" class="form-control" min="1"
                                placeholder="e.g. 10" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="stockInNote">Note</label>
                            <textarea name="note" id="stockInNote" class="form-control" rows="3"
                                placeholder="e.g. New shipment received"></textarea>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        async function doStockIn() {
            ...
            let note = document.getElementById('stockInNote').value.trim();
            ...
            let url = '<?php echo e(url("/api/v1/stocks")); ?>';
            ...
            try{
                ...
                if(response.data && response.data.success){
                    ...
                    let modalElem = document.getElementById('stockInModal');
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\Full Stack Laravel Projects by Ostad\inventory_project\resources\views/admin/stock/stockIn.blade.php ENDPATH**/ ?>