            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('stocks')); ?>" class="btn btn-outline-secondary">
                        ...
                        <a href="<?php echo e(route('invoices')); ?>" class="btn btn-outline-secondary">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        async function loadDashboardData(){
            let url = '<?php echo e(url("/api/v1/dashboard/summary")); ?>';
