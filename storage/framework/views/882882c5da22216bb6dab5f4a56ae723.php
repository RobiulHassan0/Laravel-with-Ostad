            ...
            <form id="categoryCreateForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="status" value="1" id="categoryStatus"
                            checked>
        ...
        async function createCategory() {
            ...
            try {
                ...
                if (response.data && response.data.success) {
                    ...
                    let modalElement = document.getElementById('categoryCreateModal');
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\Full Stack Laravel Projects by Ostad\inventory_project\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>