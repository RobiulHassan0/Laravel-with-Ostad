                    ...
                    <div class="product-modal-section mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="stock_qty" id="productStockQty" class="form-control" min="0"
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="image_path" id="productImagePath" class="form-control"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        async function makeCreateProduct() {
            ...
            let weight = document.getElementById('productWeight').value.trim() || null;
            ...
            try{
                ...
                if(response.data && response.data.success){
                    ...
                    let modalElem = document.getElementById('productCreateModal');
        ...
        document.getElementById('productCreateForm').addEventListener('submit', async function (e) {
            e.preventDefault();
            await makeCreateProduct();
        })
    </script>
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\Full Stack Laravel Projects by Ostad\inventory_project\resources\views/admin/products/create.blade.php ENDPATH**/ ?>