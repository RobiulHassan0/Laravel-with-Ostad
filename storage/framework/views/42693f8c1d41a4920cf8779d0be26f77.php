    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="productDeleteBtn" onclick="makeDeleteProduct()">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function deleteProduct(id){
            ...
            let modalElem = document.getElementById('productDeleteModal');
            let modal = new bootstrap.Modal(modalElem);
            modal.show();
        }

        async function makeDeleteProduct(){
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\Full Stack Laravel Projects by Ostad\inventory_project\resources\views/admin/products/delete.blade.php ENDPATH**/ ?>