        ...
        <script>
            ...
            async function getInvoices() {
                ...
                try{
                    ...
                    invoicesData = response.data['invoice_list'] || [];
                    tbody.innerHTML = '';
                    ...
                    invoicesData.forEach(item => {
                        ...
                        if(status === 'draft'){
                           actionsHtml += `
                            ...
                            actionsHtml += `<button type="button" class="btn btn-sm btn-outline-danger" disabled><i class="bi bi-trash"></i></button>`;
                        }

                        let rowContent = `
                        <tr class="${rowClass}">
                            <td class="${isCancelled ? 'text-muted' : ''}">${item['id']}</td>
                            <td>${invoiceNoHtml}</td>
                            <td class="text-muted">${invoiceDate}</td>
                            <td><span class="badge bg-secondary rounded-pill">${itemsCount}</span></td>
                            <td>$${subtotal}</td>
                            <td>${discountHtml}</td>
                            <td class="${grandTotalClass}">$ ${grandTotal}</td>
                            <td>${statusBadge}</td>
