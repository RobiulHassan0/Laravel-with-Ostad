    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="categoryDeleteBtn" onclick="makeDeleteCategory()">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function deleteCategory(id){
            ...
            let modalElem = document.getElementById('categoryDeleteModal');
...
<?php $__env->stopPush(); ?> <?php /**PATH C:\xampp\htdocs\Full Stack Laravel Projects by Ostad\inventory_project\resources\views/admin/categories/delete.blade.php ENDPATH**/ ?>