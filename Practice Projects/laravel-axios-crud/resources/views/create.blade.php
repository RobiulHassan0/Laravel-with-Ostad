...
<body class="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 min-h-screen p-10 font-sans text-gray-900">
  ...
  <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-10">
    ...
    <nav class="text-gray-500 text-sm mb-6">
      <a href="#" class="hover:underline">Dashboard</a> &rarr; <span class="font-semibold text-gray-700">Create User</span>
    </nav>
    ...
    <form class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="relative">
          ...
          <label for="name" class="absolute left-4 top-2.5 text-gray-400 text-sm transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-md peer-focus:top-2.5 peer-focus:text-sm peer-focus:text-pink-500">
            Full Name
          </label>
        </div>
        ...
        <div class="relative">
          <input type="email" name="email" id="email" placeholder=" " required
            class="peer w-full rounded-lg border-2 border-gray-300 px-4 pt-5 pb-2 text-gray-900 text-md focus:border-pink-500 focus:outline-none transition" />
          <label for="email" class="absolute left-4 top-2.5 text-gray-400 text-sm transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-md peer-focus:top-2.5 peer-focus:text-sm peer-focus:text-pink-500">
            Email Address
          </label>
        </div>
